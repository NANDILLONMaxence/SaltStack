...
Salt-api
		...
		> permet le management par [entrypoint](https://doc.traefik.io/traefik/routing/entrypoints/) via une API
...
Salt-cloud 
		...
		> permet de faire du [provisionning](https://www.redhat.com/fr/topics/automation/what-is-provisioning) dans le cloud
